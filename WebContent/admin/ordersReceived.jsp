...
<table id="customers">
        ...
        try{
        	...
        	ResultSet rs=st.executeQuery("select *from cart inner join product where cart.product_id=product_id and cart.oderDate is not NULL and cart.status='processing'");
        	while(rs.next()){
