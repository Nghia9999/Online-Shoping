      ...
      %>
          <tr>
           ...
           <td><%out.println(sno); %></td>
            ...
            <td><a href="incDecQuantityAction.jsp?id=<%=rs.getString(1)%>&quantity=dec"><i class='fas fa-plus-circle'></i></a><%=rs.getString(8)%>  <a href=""><i class='fas fa-minus-circle'></i></a></td>
